...
/*		e.preventDefault();
		...
		const taegetVal = $this.dataset.nav;
*/		const uri = new URL(location);
		const targetUri = 'http://localhost/test1/JsLesson/carCatalog/imageV.html?&num=' + prtaegetVal;
...
//		uri.href = './imageV.html?&num=' + taegetVal;
	...
	const ini =()=>{
		...
		while(index < catalogsslength){
			...
			let videoUri = 'http://localhost/test1/JsLesson/carCatalog/imageV.html?&num=' + index;
